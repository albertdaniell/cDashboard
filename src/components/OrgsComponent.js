                ...
                return (
                  <span>
                    {selectedChild1 === or.id ? (
                      ...
                      <p style={{}} onClick={() => getOrgChild1(or.id)}>
                        {or.displayName}
                      </p>
                    )}
